...
Revision ID: b491510f354e
Revises: 
Create Date: 2024-10-21 15:35:33.157364
...
def upgrade():
    ...
    sa.Column('tecnologies', sa.String(length=200), nullable=True),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('user_id')
    )
    ...
    sa.ForeignKeyConstraint(['developer_id'], ['developers.user_id'], ),
    sa.PrimaryKeyConstraint('id')
    )
